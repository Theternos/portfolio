...
console.log('%c Designed and Developed by Kavinkumar ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
...
document.addEventListener('DOMContentLoaded', function () {
  const greetings = ["Hey!", "Hola!", "Howdy!", "Wassup?", "Aloha!", "Yo!"];
  const div = document.getElementById('greeting');
  const randomIndex = Math.floor(Math.random() * greetings.length);
  div.textContent = greetings[randomIndex];
});